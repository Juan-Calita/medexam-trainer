...
export default function Level1Question({ currentCase, onAnswer, phase }) {
    ...
    <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-5">
      ...
      <div className="grid grid-cols-1 gap-2.5">
        {currentCase.options.map((opt) => {
          ...
          let cls = 'border border-slate-200 bg-white text-slate-700 hover:border-slate-300 hover:bg-slate-50';
          if (phase === 'feedback') {
