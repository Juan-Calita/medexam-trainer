  ...
  return (
    <div className="flex flex-col items-center">
      ...
      >
        ...
        {/* Impaired eye label — perspectiva do examinador: olho esquerdo do paciente fica à direita da tela */}
        {gameState === 'playing' && (
          <div style={{ position: 'absolute', top: 4, ...(leftImpaired ? { left: 8 } : { right: 8 }) }}>
