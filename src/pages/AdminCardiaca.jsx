...
export default function AdminCardiaca() {
  ...
  const { data: questions = [] } = useQuery({
    ...
    queryFn: () => base44.entities.Question.filter({ game_type: 'auscultation_cardiaca' }),
  });
      ...
      <header className="bg-white border-b border-slate-200 sticky top-0 z-40">
        <div className="max-w-6xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <h1 className="text-lg font-semibold text-slate-800">Questões - Ausculta Cardíaca</h1>
            <div className="w-24" />
          </div>
        </div>
      </header>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <Input
                    ...
                    placeholder="Ex: Padrão regular tum-tá"
                  />
                </div>
